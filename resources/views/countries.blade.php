...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr 1fr 1fr; gap: 8px;">
    ...
    <div style=" display: flex; flex-direction: column; align-items: center; height: 100%; width: 100%; border: 1px solid black; border-radius: 8px;">
        <img src="./w2560/<?php echo $country->code ?>.png" style="height: 80px; width: 80px; border-radius: 50%; margin: 6px auto;" alt="">
